...
# $Id: MesgBox.pm,v 1.3 1999/02/23 21:52:17 root Exp root $
...
sub Populate {
    ...
    delete $args->{-text} ;
    delete $args->{-icon} ;
    delete $args->{-defbutton} ;
    delete $args->{-canbutton} ;
    delete $args->{-buttons} ;
    delete $args->{-aspect} ;
    delete $args->{-justify} ;
    delete $args->{-bindctrl} ;
    delete $args->{-bindalt} ;
    delete $args->{-bindord} ;
...
This message box is similar to the MesgBox function provided with Windows. It
